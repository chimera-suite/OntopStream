...
public class RSP4JInputQueryTranslatorImpl implements RSP4JInputQueryTranslator {
    ...
    @Override
    public IQ translate(ParsedQuery pq) throws OntopUnsupportedInputQueryException, OntopInvalidInputQueryException {
        if (IS_DEBUG_ENABLED)
        ...
        System.out.println("IQ TREE(before normalization)\n: "+tree.toString()+"\n");
